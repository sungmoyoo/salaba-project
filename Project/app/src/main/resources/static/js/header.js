...
document.addEventListener('DOMContentLoaded', function(){
  ...
  $(document).on('shown.bs.modal', '#joinMemberModal', function(){
    const memberJoinForm = $('#joinMmemberModal').find('.joinMember-form');
    const emailField = memberJoinForm.find('#joinMember-email');
    const nickNameField = memberJoinForm.find('#joinMember-nickname');
